...
export const MENU_ITEMS: MenuItem[] = [
  {
    ...
    price: 45000,
    category: 'Seafood',
    image: '/images/menu/mojarra-dorada-1.png',
    images: [
      "/images/menu/mojarra-dorada-1.png",
      "/images/menu/mojarra-dorada-2.png",
      "/images/menu/mojarra-dorada-3.png",
    ],
    capture:"/images/pecera/mojarra-roja.png",
    rating: 5,
